...
- archives au format intranet pour PSL ?
- mieux spécifier les installations nécéssaires (R, RStudio) en reprenant des éléments déjà abordés dans la présentation aux DIM
- Ajouter des liens vers les différentes documentations existantes sur le blog pmeasyr ...
